...
//----------------------------- Loading 前后逻辑处理 ----------------------------------//
    ...
    this.loadingAfterInit = function () {
        ...
        // 设置菜单个人简介头像
        var blogAvatar = window.cnblogsConfig.blogAvatar ? window.cnblogsConfig.blogAvatar : 'https://cdn.jsdelivr.net/gh/Harold-666/Harold-Cnblogs-Theme-SimpleMemory@master/img/webp/default_avatar.webp';
...
//=================== 逻辑处理：非主页处理
    ...
    this.setCodeHighlighting = function () {
        ...
        function highlightjsCode() {
            tools.dynamicLoadingCss('https://cdn.jsdelivr.net/gh/Harold-666/'+(window.cnblogsConfig.GhRepositories)+'@'+(window.cnblogsConfig.GhVersions)+'/src/style/highlightjs/'+hltheme+'.min.css');
            ...
            commentList.each(function (i) {
                ...
                if (p.length > 0) {
                    ...
                    if (op.length > 0 && op.text() != '') {
                        ...
                        html += '<img class="comment-avatar" src="https://cdn.jsdelivr.net/gh/Harold-666/Harold-Cnblogs-Theme-SimpleMemory@master/img/webp/default_avatar.webp"/>';
                    }
